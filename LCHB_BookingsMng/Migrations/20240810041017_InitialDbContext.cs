        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomServiceName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    RoomServicePrice = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomStatusId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomStatusName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomTypeNumber = table.Column<int>(type: "int", nullable: false),
                    RoomTypeImage = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    FeePerNight = table.Column<decimal>(type: "decimal(8,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    RoomServiceId = table.Column<int>(type: "int", nullable: false),
                    RoomBookingServiceId = table.Column<int>(type: "int", nullable: true),
                    BookingFromDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookingToDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookingDuration = table.Column<int>(type: "int", nullable: true),
                    BookingEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BookingServiceNavBookingServiceId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BookingServiceNavBookingServiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_RoomServiceId",
                table: "Bookings",
