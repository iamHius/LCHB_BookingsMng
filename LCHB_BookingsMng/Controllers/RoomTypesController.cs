...
namespace LCHB_BookingsMng.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomTypeId,RoomTypeName,RoomTypeNumber,RoomTypeImage,FeePerNight")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomTypeId,RoomTypeName,RoomTypeNumber,RoomTypeImage,FeePerNight")] RoomType roomType)
        {
