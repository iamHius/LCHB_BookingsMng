...
namespace LCHB_BookingsMng.Controllers
{
    public class BookingRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookingId,RoomId,RoomServiceId,RoomBookingServiceId,BookingFromDate,BookingToDate,BookingDuration,BookingEmail")] BookingRoom bookingRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,RoomId,RoomServiceId,RoomBookingServiceId,BookingFromDate,BookingToDate,BookingDuration,BookingEmail")] BookingRoom bookingRoom)
        {
