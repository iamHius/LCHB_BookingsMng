...
namespace LCHB_BookingsMng.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PayId,PaymentCode,PayStatus")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PayId,PaymentCode,PayStatus")] Payment payment)
        {
            if (id != payment.PayId)
            {
                return NotFound();
